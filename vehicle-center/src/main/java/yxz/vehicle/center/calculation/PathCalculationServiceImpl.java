package yxz.vehicle.center.calculation;
 ...
 * 核心功能_路径计算
 * author yangxiumei
 * date 2021/4/28 23:51
 */
@Slf4j
@Service
@RequiredArgsConstructor
public class PathCalculationServiceImpl implements IPathCalculationService {

    private final RoadInfoServiceImpl roadInfoService;
    private List<List<RoadInfo>> globalList  = new ArrayList<>();


    @Override
    public List<List<RoadInfo>> getPaths(Integer startPointId, Integer endPointId) {
